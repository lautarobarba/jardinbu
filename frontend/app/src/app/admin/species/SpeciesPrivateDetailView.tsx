...
interface SpeciesPrivateDetailViewProps {
    toggleVisibility: Function;
    id: number;
}

export const SpeciesPrivateDetailView = (props: SpeciesPrivateDetailViewProps) => {
    ...
    return (
        <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-6">
                ...
                <p className="text-gray-500 text-xl flex flex-row items-center ml-[0.5rem]">Reino<ChevronRight /></p>
                <p className="text-xl font-bold text-dark dark:text-light ml-[1rem]">
                ...
                <p className="text-gray-500 text-xl flex flex-row items-center ml-[1.5rem]">Filo<ChevronRight /></p>
                <p className="text-xl font-bold text-dark dark:text-light ml-[2rem]">
                ...
                <p className="text-gray-500 text-xl flex flex-row items-center ml-[2.5rem]">Clase<ChevronRight /></p>
                <p className="text-xl font-bold text-dark dark:text-light ml-[3rem]">
                ...
                <p className="text-gray-500 text-xl flex flex-row items-center ml-[3.5rem]">Orden<ChevronRight /></p>
                <p className="text-xl font-bold text-dark dark:text-light ml-[4rem]">
                ...
                <p className="text-gray-500 text-xl flex flex-row items-center ml-[4.5rem]">Familia<ChevronRight /></p>
                <p className="text-xl font-bold text-dark dark:text-light ml-[5rem]">
                ...
                <p className="text-gray-500 text-xl flex flex-row items-center ml-[5.5rem]">Género<ChevronRight /></p>
                <p className="text-xl font-bold text-dark dark:text-light ml-[6rem]">
...
interface ModalSpeciesPrivateDetailViewProps {
    id: number;
}

export const ModalSpeciesPrivateDetailView = (props: ModalSpeciesPrivateDetailViewProps) => {
    const { id } = props;
                    ...
                    <ModalThemeWrapper>
                        <ModalContent>
                            <div className='p-5 bg-light dark:bg-dark'>
                                <SpeciesPrivateDetailView toggleVisibility={setShowDetailModal} id={id} />
                            </div>
                        </ModalContent>
                    </ModalThemeWrapper>
                </Modal>
