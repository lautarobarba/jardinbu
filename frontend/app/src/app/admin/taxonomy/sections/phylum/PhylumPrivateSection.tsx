...
interface PhylumPrivateSectionProps {
  updateTitle: Dispatch<SetStateAction<string>>;
}

export const PhylumPrivateSection = (props: PhylumPrivateSectionProps) => {
    ...
    <div className='p-3'>
      ...
      <div className="grid grid-cols-12 gap-2 mt-2">
        <div className="col-span-12 md:col-span-4 order-1 flex justify-center md:justify-start items-center">
          <PageSubTitle title='Listado de filos' className='mb-0' />
        </div>
      ...
      {getPhylumsIsSuccess && (
        <section id='phylums' className='phylums'>
          <CustomTable table={table} totalItems={getPhylumsData.meta.totalItems ?? 0} />
        </section>
      )}
    </div>
  );
