...
export const DashboardNavbar = () => {
  return (
    <nav className="bg-navbar-bg border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
              ...
              >
                ...
                <div className="pl-3 w-full">
                  ...
                  >
                    ...
                    >Bonnie Green</span>: {`"Hey, what's up? All set for the presentation?"`}
                  </div>
                  <div
